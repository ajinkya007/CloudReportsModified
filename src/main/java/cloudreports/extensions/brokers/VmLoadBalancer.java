 ...
 * balancer used by a {@link DatacenterController}. The main method all load
 * balancers should implement is <code>public int getNextAvailableVm()</code>.
 *
 * This class provides a basic load balancing statistic collection that can be
 * used by implementing classes. The implementing classes should call the
 *  <code>void allocatedVM(int currVm)</code> method to use the statisitics
 * collection feature.
 *
  */
