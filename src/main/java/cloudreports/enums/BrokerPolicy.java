...
import cloudreports.extensions.brokers.ActiveVmLoadBalancer;
import cloudreports.extensions.brokers.Priority;
import cloudreports.extensions.brokers.RoundRobinDatacenterBroker;
import cloudreports.extensions.brokers.RoundRobinVirtualMachine;
import cloudreports.extensions.brokers.ThrottledVmLoadBalancer;
...
public enum BrokerPolicy implements Serializable {
    ...
    ROUND_ROBIN_VIRTUAL_MACHINE {
        @Override
        public DatacenterBroker createBroker(String customerName, String brokerAlias) {
            try{
                return new RoundRobinVirtualMachine(customerName);
            }
            catch(Exception e) {
                return null;
            }
    ...
    THROTTLED {
        ...
        public DatacenterBroker createBroker(String customerName, String brokerAlias) {
            try{
                return new ThrottledVmLoadBalancer(customerName);
            }
            catch(Exception e) {
                return null;
            }
    ...
    /** The Active Vm Load Balancing broker policy.
     *  Its {@link #createBroker(java.lang.String, java.lang.String) } method 
     */    
    ACTIVE_VM_lOAD{
        @Override
        public DatacenterBroker createBroker(String customerName, String brokerAlias) {
            try{
                return new ActiveVmLoadBalancer(customerName);
            }
            catch(Exception e) {
                return null;
            }
    ...
    /** The Priority Based broker policy.
     *  Its {@link #createBroker(java.lang.String, java.lang.String) } method 
     *  
     */    
    PRIORITY {
        ...
        public DatacenterBroker createBroker(String customerName, String brokerAlias) {
            try{
                return new Priority(customerName);
            }
            catch(Exception e) {
                return null;
            }
    ...
    public static BrokerPolicy getInstance(String alias) {
        if(alias.equals("Round Robin Datacenter")) return BrokerPolicy.ROUND_ROBIN_DATA_CENTER;
        else if(alias.equals("Round Robin Virtual Machine")) return BrokerPolicy.ROUND_ROBIN_VIRTUAL_MACHINE;        
        else if(alias.equals("Throttled Load Balancer")) return BrokerPolicy.THROTTLED;
        else if(alias.equals("Active Vm Load Balancer")) return BrokerPolicy.ACTIVE_VM_lOAD;
        else if(alias.equals("Priority Based Load Balancer")) return BrokerPolicy.PRIORITY;
    ...
    public static String[] getBrokerPoliciesNames() {
        String[] nativePolicies = new String[] {"Round Robin Datacenter","Round Robin Virtual Machine","Throttled Load Balancer","Active Vm Load Balancer","Priority Based Load Balancer"};
